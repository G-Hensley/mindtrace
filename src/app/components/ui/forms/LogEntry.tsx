...
export default function LogEntry() {
  ...
  return (
    // Log Entry Form
    <div className={`w-full flex flex-col relative h-fit ${isOpen ? 'gap-2': ''}`}>
      ...
      <form
        ...
        className={`${isOpen ? 'opacity-100 scale-y-100 h-auto p-4 border' : 'opacity-0 scale-y-0 h-0'} w-full bg-gray-950/90 rounded-lg flex flex-col gap-4 border-gray-800/90
