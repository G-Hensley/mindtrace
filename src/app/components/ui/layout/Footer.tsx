...
export default function Footer() {
  return (
    <footer className='w-full relative mt-auto text-center text-gray-400 z-40' aria-label='Footer'>
      ...
      <p className='text-sm sm:text-base font-lato w-fit bg-gray-950/50 py-2 px-4 rounded-t-lg mx-auto border border-gray-800/90 backdrop-blur-sm' aria-label='Copyright Text, Version 1.0.0'>
